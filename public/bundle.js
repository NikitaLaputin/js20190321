...
/* harmony import */ var _Portfolio_Portfolio_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(19);
/* harmony import */ var _TradeWidget_TradeWidget_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(20);
/* harmony import */ var _Filter_Filter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(21);
/* harmony import */ var _services_DataService_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(22);
...
/* harmony import */ var _BaseComponent_BaseComponent_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(18);
...
function (_BaseComponent) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(Table, _BaseComponent);
  ...
  function Table(_ref) {
    ...
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4___default()(Table).call(this));
    _this._el = element;

    _this._render(data);

    var rows = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(_this._el.querySelectorAll('tbody tr'));
  ...
  return Table;
}(_BaseComponent_BaseComponent_js__WEBPACK_IMPORTED_MODULE_6__["default"]);
...
/* harmony import */ var _BaseComponent_BaseComponent_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(18);
...
var DataService = {
  ...
  getCurrencies: function () {
    var _getCurrencies = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
      var _ref,
          filter,
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _ref = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, filter = _ref.filter;
              params = Object.assign(this.defaultParams, filter);
              _context2.next = 4;
            ...
            case 4:
              ...
              this._filteredData = activeCoins.filter(function (coin) {
              ...
              if (params.type && params.property) {
                ...
                this._filteredData = DataService.sortCoins({
                  type: params.type,
                  property: params.property
                });
              }

              return _context2.abrupt("return", DataService.getCurrenciesPrices(this._filteredData.slice(0, 10)));
  ...
  getCurrenciesPrices: function () {
    var _getCurrenciesPrices = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
    /*#__PURE__*/
    ...
    function getCurrenciesPrices(_x2) {
      return _getCurrenciesPrices.apply(this, arguments);
    }

    return getCurrenciesPrices;
  }(),
  sortCoins: function sortCoins(_ref2) {
    ...
    return this._filteredData.sort(function (a, b) {
      switch (type) {
        case 'number':
          return _this2.defaultParams.descending ? +a[property] - +b[property] : +b[property] - +a[property];

        default:
          return _this2.defaultParams.descending ? a[property].localeCompare(b[property]) : b[property].localeCompare(a[property]);
      }
    });
  }
};
